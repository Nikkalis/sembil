import { a as require_browser_external_stream, i as require_browser_external_path, n as require_browser_external_crypto, o as __commonJSMin, r as require_browser_external_url, t as require_browser_external_fs } from "./browser-external_fs-B946xqFb.js";
...
//#endregion
//#region node_modules/cloudinary/lib/utils/handleFileParameter.js
var require_handleFileParameter = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	function handleFileParameter(file) {
		...
		if (typeof file === "string" && !isRemoteUrl(file)) return {
...
var require_uploader$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var fs = require_browser_external_fs();
	var { extname, basename } = require_browser_external_path();
	var Writable = require_browser_external_stream().Writable;
	var { upload_prefix } = require_config()();
	var https = !(upload_prefix && upload_prefix.slice(0, 5) === "http:") ? require_browser_external_https() : require_browser_external_http();
	var { URL } = require_browser_external_url();
	var Cache = require_cache();
	var utils = require_utils();
	var UploadStream = require_upload_stream();
	var config = require_config();
	require_ensureOption().defaults(config());
	...
	*/
	...
	function post(url, post_data, boundary, file, callback, options) {
		...
		else if (!post_options.agent) post_options.agent = new https.Agent(proxy);
...
var require_execute_request = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var config = require_config();
	var https = /^http:/.test(config().upload_prefix) ? require_browser_external_http() : require_browser_external_https();
	var querystring = require_browser_external_querystring();
	var utils = require_utils();
	var ensureOption = require_ensureOption().defaults(config());
	var { URL } = require_browser_external_url();
	...
	function buildMultipartBody(params, boundary) {
		...
		utils.hashToParameters(params).forEach(([key, value]) => {
			...
			} else parts.push(Buffer.from(encodeFieldPart(boundary, key, value), "utf8"));
		});
	...
	*/
	...
	exports.visual_search = function visual_search(params, callback, options = {}) {
		...
		if (image_file != null) {
			...
			if (typeof image_file === "object") requestOptions = extend({}, options, { content_type: "multipart" });
		}
